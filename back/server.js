...
app.post('/user/send/survey', (req, res) => {
  ...
  mailsArray.map(mail => {
    ...
    let mailOptions = {
      ...
      déplacement des salariés de l’entreprise.</p><p>En effet, votre employeur travaille à la mise en place d’un plan de mobilité.
      Cette démarche a pour objectif de vous proposer, pour vos déplacements
